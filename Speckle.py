...
class CommandSpeckle:
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(os.path.dirname(__file__), "icons", 'speckle.svg'),
                ...
                'ToolTip': QT_TRANSLATE_NOOP("WebTools_Speckle",
                                             "Connects and interacts with a Specke.Works server instance")}
...
class SpeckleTaskPanel:
    ...
    def __init__(self):
        ...
        self.form = FreeCADGui.PySideUic.loadUi(os.path.join(os.path.dirname(__file__), "ui", "DialogSpeckle.ui"))
